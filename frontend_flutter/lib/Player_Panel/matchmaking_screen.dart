...
class _MatchmakingScreenState extends State<MatchmakingScreen> {
  ...
  Future<void> _joinMatch(String matchId) async {
    ...
    try {
      final res = await ApiService.post('/player/bookings/$matchId/join', token, {});
      final body = jsonDecode(res.body);
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text("Available", style: TextStyle(color: Colors.green.shade700, fontSize: 12, fontWeight: FontWeight.bold)),
                          ),
                        ],
                      ),
                    ),
                            ...
                            child: Column(
                              children: [
                                Row(
                                  ...
                                  children: [
                                    _playerAvatar(hostName, profilePic),
